...
//					std::string nombreArchivo = "tablero.txt";
					int n;
					int** tablero;
					generar.cargarTablero("tablero.txt", tablero, n);
					generar.dibujarTablero(tablero, n);
					generar.liberarTablero(tablero, n);
					break;
				case 2:
					exit(0);
					break;
